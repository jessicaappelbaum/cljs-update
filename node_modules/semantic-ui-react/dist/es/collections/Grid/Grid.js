...
Grid._meta = {
  ...
  props: {
    celled: ['internally'],
    columns: [].concat(_toConsumableArray(SUI.WIDTHS), ['equal']),
    divided: ['vertically'],
...
process.env.NODE_ENV !== "production" ? Grid.propTypes = {
  ...
  celled: PropTypes.oneOfType([PropTypes.bool, PropTypes.oneOf(Grid._meta.props.celled)]),
  ...
  divided: PropTypes.oneOfType([PropTypes.bool, PropTypes.oneOf(Grid._meta.props.divided)]),

  /** A grid can double its column width on tablet and mobile sizes. */
  doubling: PropTypes.bool,

  /** A grid can preserve its vertical and horizontal gutters on first and last columns. */
  padded: PropTypes.oneOfType([PropTypes.bool, PropTypes.oneOf(Grid._meta.props.padded)]),

  /** A grid can increase its gutters to allow for more negative space. */
  relaxed: PropTypes.oneOfType([PropTypes.bool, PropTypes.oneOf(Grid._meta.props.relaxed)]),
